      ...
      <TabView>
        <TabPanel header={t('settings.about.tabAbout')}>
          <p className="mb-2 line-height-3">
            ...
            with tools to help manage the crafting and economic aspects of the game. This app is
            free to use, and records no information about you (all the data is stored locally in
            your browser).
          </p>

          <p className="mb-2 line-height-3">
            If the first thing you thought when opening this app was "Wow, it looks a heck of a lot
            like{' '}
            <a href="https://eco-gnome.com" target="_blank" rel="noopener noreferrer">
              Eco Gnome
            </a>
            ", you're right! I've been a long-time user of Eco Gnome, as well as other calculators
            like{' '}
            ...
            . Eco Gnome was by far my favorite, but as time went on I wasn't sure if it was going to
            receive updates to support the changes in v13 of Eco (it eventually did!), and there was
            a growing list of features I thought would be great to add. So, one rainy weekend I
            started hacking, and here we are: a new Eco calculator tool, heavily inspired by the
            great work of Eco Gnome, but with some new bells and whistles.
          </p>

          <p className="mb-2 line-height-3">
            This app is still a bit new, so there's bound to be bugs. Please have patience, I'll
            squash them as fast as I'm able. Feel free to{' '}
